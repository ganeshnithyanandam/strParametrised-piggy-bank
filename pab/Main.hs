...
import           Plutus.Contracts.StrParameterisedPiggyBank          as StrParameterisedPiggyBank
...
data StarterContracts =
    StrParameterisedPiggyBankContract
...
instance Builtin.HasDefinitions StarterContracts where
    getDefinitions = [StrParameterisedPiggyBankContract]
    getSchema =  \case
        StrParameterisedPiggyBankContract -> Builtin.endpointsToSchemas @StrParameterisedPiggyBank.StrParameterisedPiggyBankSchema
    getContract = \case
        StrParameterisedPiggyBankContract -> SomeBuiltin (StrParameterisedPiggyBank.endpoints @ContractError)
